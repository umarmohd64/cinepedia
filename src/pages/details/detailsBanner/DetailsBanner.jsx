                                            ...
                                            <span className="text">
                                                { director?.map( (d,i) => (
                                                    <span key={i} >
                                                        ...
                                                        {/* IF MULTIPLE DIRECTORS, TO LAST WALE KO CHHORKE  BAAKI SABKE BAAD COMMA(,) LAG JAYEGA */}
                                            ...
                                            <span className="text">
                                                { writer?.map( (d,i) => (
                                                    <span key={i} >
                                                        ...
                                                        {/* IF MULTIPLE Writers, TO LAST WALE KO CHHORKE  BAAKI SABKE BAAD COMMA(,) LAG JAYEGA */}
